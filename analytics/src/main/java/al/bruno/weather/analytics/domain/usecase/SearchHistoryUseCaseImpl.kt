package al.bruno.weather.analytics.domain.usecase
...
class SearchHistoryUseCaseImpl @Inject constructor(
     ...
     *
     * The [query] parameter works only if it's length is at least [obg.android.feature.analytics.domain.usecase.SearchHistoryUseCase.Companion.MIN_QUERY_LENGTH]. The [services]
